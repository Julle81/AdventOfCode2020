with open('temp_day_04_input.txt') as f:
...
#    print(passport)
    ...
    if( byr_index != -1 ):
        ...
        if( len(byr) != 4 or (int(byr) < 1920 or 2020 <= int(byr))):
    ...
    if( hgt_index != -1 and passport_valid ):
        ...
        if( hgt[-2:] == 'in' or hgt[-2:] == 'cm' ):
            ...
            if( (hgt[-2:] == 'in' and (int(height) < 59 or int(height) > 76 ))):
                passport_valid = False
            elif(hgt[-2:] == 'cm' and (int(height) < 150 or int(height) > 190) ):
                passport_valid = False
        else:
            passport_valid = False
    else:
